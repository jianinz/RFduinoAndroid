...
public class RfduinoScanActivity extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		final Intent intent = new Intent(this, RfduinoControlActivity.class);
		intent.putExtra(RfduinoControlActivity.EXTRAS_DEVICE_NAME, device.getName());
		intent.putExtra(RfduinoControlActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
		if (mScanning) {
